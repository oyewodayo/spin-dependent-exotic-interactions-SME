...
each has been a source of transcription error in earlier drafts of this
work. First, $V_2$ is spin--spin ($\boldsymbol\sigma_1\cdot\boldsymbol\sigma_2$),
...
odd and therefore subleading; and $d_{\mu\nu}$ (Section 3.4), treated with
the same method but flagged as not yet independently verified by executable
symbolic computation in the way the other two coefficients are. In every
