...
The Standard Model has been tested to extraordinary precision, from
electroweak measurements to collider discoveries, and nothing in the data so
far breaks it outright. Even so, it is not a complete theory. It says nothing
about gravity at the quantum level, it has no dark matter candidate despite
dark matter making up roughly a quarter of the universe's energy budget
\cite{Planck2018},
and it cannot account for why the universe is full of matter and almost no
antimatter, when the early universe is expected to have produced nearly equal
amounts of both. The strong charge-parity (CP) problem sits alongside these:
quantum chromodynamics (QCD), the Standard Model's theory of the strong
interaction, allows a CP-violating term in its Lagrangian, but no such
violation has ever been seen in strong-interaction experiments. Axions were
originally proposed to explain exactly this, via the Peccei--Quinn mechanism.

None of these gaps come with a guaranteed solution, but they are usually taken
as evidence that there is physics beyond the Standard Model (BSM) still to be
found. One well-motivated possibility is a new class of light, weakly coupled
bosonic fields, such as axions, axion-like particles, dark photons, or extra
gauge bosons from grand-unified or string-theoretic constructions, that
mediate feeble, long-range interactions with ordinary matter. These are usually called
\emph{fifth forces}, since they sit outside the four known fundamental
interactions.

This thesis is concerned with a specific subset of fifth forces: those that
couple to fermion spin rather than to charge or mass alone. \emph{Spin-dependent
exotic interactions} are worth singling out because spin has no classical
analogue: it is a purely quantum degree of freedom, which makes it an
unusually clean channel for looking for symmetry violation without the
backgrounds that plague charge- or mass-coupled searches. Depending on the
mediator and the coupling structure, these interactions show up as
monopole--dipole, dipole--dipole, or velocity-dependent potentials, typically
of Yukawa form with a range set by the mediator mass. A confirmed detection in
any of these channels would be direct evidence of BSM physics.

The experimental side of this search has moved quickly in the last decade.
Nitrogen-vacancy centre magnetometry, magnetometers based on superconducting
quantum interference devices (SQUIDs), atomic co-magnetometers,
torsion-pendulum experiments, and antihydrogen spectroscopy
have each pushed the bounds on exotic spin couplings down by orders of
magnitude, and each probes a different combination of interaction range and
particle species. Separately, antimatter physics has become one of the sharper
tools available for testing fundamental symmetries: experiments at the
European Organization for Nuclear Research (CERN) such as BASE (Baryon
Antibaryon Symmetry Experiment) and ALPHA (Antihydrogen Laser Physics
Apparatus) now compare matter and antimatter magnetic moments,
charge-to-mass ratios, and spectral lines at a precision that puts real
pressure on charge-parity-time (CPT) invariance, the combined symmetry
under charge conjugation, parity, and time reversal, and one of the few
symmetries that relativistic quantum field theory does not allow you to
give up without abandoning locality or Lorentz invariance along with it.

Putting these two threads together, spin-dependent exotic interaction
searches and antimatter precision physics, opens a regime that has not
really been explored: if an exotic interaction couples with different strength
to matter and antimatter, that difference should show up as a measurable
asymmetry in the corresponding coupling constants. Testing this properly
means being able to move between two very different descriptions of the same
physics: the relativistic, field-theoretic language in which Lorentz and CPT
violation are naturally written down, and the non-relativistic potentials that
experiments actually constrain. That translation is what this thesis builds,
by connecting the Standard Model Extension to the Dobrescu--Mocioiu
