...
amounts of both. The strong CP problem sits alongside these: QCD allows a
CP-violating term in its Lagrangian, but no such violation has ever been seen
in strong-interaction experiments. Axions were originally proposed to explain
exactly this, via the Peccei--Quinn mechanism.
...
Nitrogen-vacancy centre magnetometry, SQUID-based magnetometers, atomic
...
tools available for testing fundamental symmetries: CERN experiments such as
BASE and ALPHA now compare matter and antimatter magnetic moments,
charge-to-mass ratios, and spectral lines at a precision that puts real
pressure on CPT invariance, one of the few symmetries that relativistic
quantum field theory does not allow you to give up without abandoning locality
or Lorentz invariance along with it.
